...
const Footer = () => {
	return (
		<div style={{ background: "#000", padding: "1rem", margin: "0rem" }}>
			<Container>
				<Grid container spacing={2} sx={{ alignItems: "start" }}>
					<Grid item sm={4}>
						...
						<Typography
							variant="p"
							sx={{ opacity: "80%", lineHeight: "1.4rem" }}
						>
							...
							massa. Suspendisse porta eros mi, non posuere augue sagittis
							commodo.
						</Typography>
					</Grid>
					...
					<Grid item sm={12}>
						...
						>
							Copyrights {new Date().getFullYear()}, Developed by Bibek
